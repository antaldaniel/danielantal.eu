...
summary: ''
authors: []
lastmod: '2020-04-14T22:23:37+01:00'
featured: yes
draft: yes
image:
  caption: ''
...
```{r workhome, echo=FALSE, warning=FALSE, out.width='90%', fig.asp=9/16}
covid_dir <- 'C:/Users/Daniel Antal/OneDrive - Visegrad Investments/2020 Projektek/covid19'
plot ( readRDS( file.path(covid_dir, "plots", "work_home_en.rds")) )
```
...
\newpage
```{r changes, echo=FALSE, warning=FALSE, out.width='90%'}
knitr:::include_graphics(file.path(covid_dir, "plots", "difference_summary_en.jpg"))
```
...
```{r clustering, echo=FALSE, warning=FALSE, out.width='90%'}
knitr::include_graphics(file.path(covid_dir, 'plots', 'countryclusters.jpg'))
```
...
_Use this in your article? Further research? Collaboration? The data & code is available in a private github repo. Let's get in touch on LinkedIn, Twitter, or via danielantal.eu_
